...
const SelectClient = ({
  ...
  return (
    <td
      ...
      ref={dropdownRef}
      style={{ backgroundColor: currentOption ? ` white` : "white" }}
      className={`${classes}  relative cursor-pointer capitalize text-black text-nowrap text-center w-36  hover:!bg-maingreen`}
    >
      {currentOption}
      {isOpen && (
